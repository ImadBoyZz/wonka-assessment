...
/* Generation time. definition -> parse -> annotate (1 LLM call) -> merge ->
 * UISpec, cached on hash(definition). Changing the definition file is the only
 * way to get a different UI. */
